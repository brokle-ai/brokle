...
import { useSpansTableState } from '../hooks/use-project-spans'
import { DataTableColumnHeader } from '@/features/traces/components/data-table-column-header'
import { ItemBadge } from '@/features/traces/components/item-badge'
...
import { statuses, statusCodeToString } from '@/features/traces/data/constants'
...
export function SpansTable({ data, totalCount, isFetching }: SpansTableProps) {
  ...
  // Row click handler - navigates to the trace containing this span
