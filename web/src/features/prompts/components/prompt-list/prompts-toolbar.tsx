...
import type { UsePromptsTableStateReturn } from '../../hooks/use-prompts-table-state'
...
type PromptsToolbarProps<TData> = {
  table: Table<TData>
  tableState: UsePromptsTableStateReturn
  onReset?: () => void
}
...
export function PromptsToolbar<TData>({
  ...
  // This bypasses table.setGlobalFilter() → onGlobalFilterChange callback chain
  useEffect(() => {
