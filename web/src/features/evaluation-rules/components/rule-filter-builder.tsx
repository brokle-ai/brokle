...
// Column definitions for evaluation rule filters
export interface RuleFilterColumn {
  id: string
  label: string
...
// Default columns for evaluation rules
export const RULE_FILTER_COLUMNS: RuleFilterColumn[] = [
  {
    id: 'span_name',
    label: 'Span Name',
    type: 'string',
...
interface RuleFilterBuilderProps {
  ...
  disabled?: boolean
  maxFilters?: number
  columns?: RuleFilterColumn[]
}

/**
 * Inline filter builder for evaluation rules.
 *
 * Features:
