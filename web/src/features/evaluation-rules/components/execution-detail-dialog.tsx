...
import { useRuleExecutionDetailQuery } from '../hooks/use-rule-executions'
import type {
  RuleExecutionDetail,
  SpanExecutionDetail,
...
function ExecutionSummary({ execution }: { execution: RuleExecutionDetail }) {
  const avgScore =
...
export function ExecutionDetailDialog({
  ...
  const { data: execution, isLoading, error } = useRuleExecutionDetailQuery(
    projectId,
    ruleId,
    executionId ?? '',
              ...
              <Tabs defaultValue="spans" className="w-full">
                ...
                <TabsContent value="debug" className="mt-4">
                  <div className="space-y-4">
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <code className="font-mono text-xs">{execution.rule_id}</code>
                          </div>
                          <div>
                    ...
                    {/* Rule snapshot */}
                    {execution.rule_snapshot && (
                      <Card>
                        <CardHeader className="py-3">
                          <CardTitle className="text-sm">Rule Configuration (at execution time)</CardTitle>
                        </CardHeader>
                        <CardContent>
                          <CodeBlock
                            content={JSON.stringify(execution.rule_snapshot, null, 2)}
                          />
                        </CardContent>
                      </Card>
                    )}
