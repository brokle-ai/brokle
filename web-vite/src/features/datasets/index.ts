...
// The web/ convenience `<DatasetDetail>` wrapper was not ported to
// web-vite — the detail route uses `<DatasetDetailLayout>` + Outlet
// directly, matching the Next.js layout.tsx + page.tsx split.
