...
// SVG adapter logos. Each path is a simplified public-domain mark — no
// trademark shapes beyond what the public web already surfaces in icon
// libraries. Fallback case covers `custom` + any future provider.
