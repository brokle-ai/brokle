...
const createProjectMember = `-- name: CreateProjectMember :execrows
...
func (q *Queries) CreateProjectMember(ctx context.Context, arg CreateProjectMemberParams) (int64, error) {
	result, err := q.db.Exec(ctx, createProjectMember,
		arg.UserID,
		arg.ProjectID,
		arg.RoleID,
		arg.JoinedAt,
...
project_in_org AS (
    ...
    UNION ALL
    SELECT 1
    WHERE $3::uuid = '00000000-0000-0000-0000-000000000000'::uuid
),
active_project AS (
    SELECT pm.role_id
    FROM project_members pm
