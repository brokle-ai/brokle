-- Rollback: drop_telemetry_tables
-- Created: 2025-10-16T22:27:30+05:30
--
-- Recreate PostgreSQL telemetry tables (if rollback is needed)
-- Note: This is unlikely to be used as we're migrating to Redis Streams permanently
