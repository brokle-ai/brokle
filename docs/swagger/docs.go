...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/billing.ListInvoicesResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/environment.ListEnvironmentsResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/organization.ListOrganizationsResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/organization.ListMembersResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/rbac/organizations/{orgId}/roles": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/rbac/organizations/{orgId}/stats": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/response.RoleStatistics"
                        }
                    },
                    "400": {
                        "description": "Bad request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.CreatePermissionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/rbac/permissions/resources": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/rbac/permissions/resources/{resource}/actions": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/rbac/roles/{roleId}": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Forbidden (system role cannot be updated)",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Forbidden (system role cannot be deleted)",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/rbac/users/{userId}/organizations/{orgId}/permissions": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/response.UserPermissionsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/api/v1/rbac/users/{userId}/organizations/{orgId}/permissions/check": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.CheckPermissionsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/response.CheckPermissionsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/api/v1/rbac/users/{userId}/organizations/{orgId}/role": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "organization.ListMembersResponse": {
            "type": "object",
            "properties": {
                "members": {
                    "type": "array",
        ...
        "organization.ListOrganizationsResponse": {
            "type": "object",
            "properties": {
                "limit": {
                    "type": "integer",
        ...
        "response.PermissionResponse": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Permission to read user information"
                },
                "display_name": {
                    "type": "string",
                    "example": "Read Users"
