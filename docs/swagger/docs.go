...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/auth/sessions/revoke-all": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Revocation options",
                        "name": "request",
                        "in": "body",
                        "schema": {
        ...
        "/api/v1/users/me/preferences": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Preferences update information",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_transport_http_handlers_user.UpdatePreferencesRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_transport_http_handlers_user.UpdatePreferencesRequest": {
